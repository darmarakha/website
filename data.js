...
const T = {
    ...
    'proj.subtitle': { id:'Klik tombol Lihat Proyek untuk membuka file/proyek dan membaca penjelasan detailnya.', en:'Click View Project to open the project file and read the detailed explanation.' },
    'proj.viewBtn': { id:'Kunjungi Proyek', en:'Visit Project' },
    'proj.detailBtn': { id:'Detail Proyek', en:'Project Details' },
    'proj.openFileBtn': { id:'Lihat Proyek', en:'View Project' },
    'proj.filePreview': { id:'Preview File Proyek', en:'Project File Preview' },
    'proj.openNewTab': { id:'Buka di Tab Baru', en:'Open in New Tab' },
    'proj.noFile': { id:'File proyek belum tersedia. Tambahkan fileUrl di data.js.', en:'Project file is not available yet. Add fileUrl in data.js.' },
...
const projData = [
    {
        ...
        fileUrl:'/edit/uploads/1777174476_AnalisisAktivitasRadioisotopremovedpage0001.jpg',
        fileLabel:'Analisis Radioisotop K-40',
        tags:['COSINE-100','Dark Matter','Science'],
        titleKey:'proj.t1', descKey:'proj.d1', detailKey:'proj.detail1', span:'',
        linkUrl: '' // Opsional: isi URL live project jika ada
    },
    {
        imgSrc:'/edit/uploads/1777565632_Screenshot20260430230724.png',
        fullSrc:'/edit/uploads/1777565632_Screenshot20260430230724.png',
        fileUrl:'/Belajar/Bahasa-Jepang/index.php',
        fileLabel:'Website Belajar Bahasa Jepang',
        tags:['Machine Learning','Japanese','Web App'],
        titleKey:'proj.t2', descKey:'proj.d2', detailKey:'proj.detail2', span:'',
        linkUrl: '/Belajar/Bahasa-Jepang/index.php'
    },
    {
        imgSrc:'https://picsum.photos/seed/project-esp32-iot/600/375.jpg',
        fullSrc:'https://picsum.photos/seed/project-esp32-iot/600/375.jpg',
        fileUrl:'',
        fileLabel:'',
        tags:['ESP32-CAM','IoT'],
        titleKey:'proj.t3', descKey:'proj.d3', detailKey:'proj.detail3', span:'sm:col-span-2 md:col-span-1',
        linkUrl: '' // Opsional: isi URL live project jika ada
    },
];
...
const projI18n = {
    ...
    'proj.detail1': {
        id:'Proyek ini berfokus pada analisis aktivitas radioisotop Kalium-40 menggunakan data SET 1 selama 48 hari. Proses utamanya mencakup pembacaan data eksperimen, seleksi event multi-hit, identifikasi puncak energi, pemodelan background, serta interpretasi hasil untuk mendukung studi latar belakang pada eksperimen COSINE-100. Output proyek dapat dipakai sebagai dokumentasi analisis ilmiah dan portofolio riset berbasis data.',
        en:'This project focuses on analyzing Potassium-40 radioisotope activity using 48 days of SET 1 data. The main process includes experimental data reading, multi-hit event selection, energy peak identification, background modeling, and result interpretation to support background studies in the COSINE-100 experiment. The output can be used as scientific analysis documentation and a data-driven research portfolio.'
    },
    'proj.detail2': {
        id:'Proyek ini adalah website pembelajaran Bahasa Jepang yang dirancang untuk membantu pengguna belajar dari level dasar. Fitur utamanya meliputi materi hiragana/katakana, latihan flashcard, latihan membaca, dan tampilan belajar yang responsif. Bagian proyek dapat dibuka langsung agar pengunjung melihat hasil website, bukan hanya membaca deskripsinya.',
        en:'This project is a Japanese learning website designed to help users learn from the basic level. Its main features include hiragana/katakana materials, flashcard practice, reading practice, and a responsive learning interface. The project can be opened directly so visitors can see the actual website, not only read the description.'
    },
    'proj.detail3': {
        id:'Proyek ini merupakan eksplorasi sistem pemantauan berbasis ESP32-CAM dan Internet of Things. Fokusnya adalah memahami cara kerja kamera mikro-kontroler, konektivitas jaringan, pengambilan gambar, serta peluang pengembangan menjadi sistem monitoring sederhana.',
        en:'This project explores a monitoring system based on ESP32-CAM and the Internet of Things. It focuses on understanding microcontroller camera behavior, network connectivity, image capture, and the possibility of developing it into a simple monitoring system.'
    },
};