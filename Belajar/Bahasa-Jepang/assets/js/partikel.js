...
// Bank Soal Quiz
const quizBank = [
    { "soal": "わたし ___ みず ___ のみます。", "options": ["A. は・を", "B. が・に", "C. で・を", "D. の・が"], "jawaban": 0, "penjelasan": "は menandai topik 'saya'. を menandai objek 'air' yang diminum." },
    { "soal": "がっこう ___ べんきょうします。", "options": ["A. に", "B. で", "C. へ", "D. を"], "jawaban": 1, "penjelasan": "で dipakai karena 'belajar' adalah sebuah aksi yang dilakukan di suatu tempat." },
    { "soal": "へや ___ ねこ ___ います。", "options": ["A. で・は", "B. に・が", "C. に・を", "D. へ・が"], "jawaban": 1, "penjelasan": "に menandai lokasi keberadaan benda bernyawa. が menandai subjek (kucing)." },
    { "soal": "Ini adalah buku saya. -> わたし ___ ほん です。", "options": ["A. が", "B. は", "C. の", "D. も"], "jawaban": 2, "penjelasan": "の digunakan untuk menunjukkan kepemilikan." },
    { "soal": "あした、にほん ___ いきます。", "options": ["A. で", "B. を", "C. が", "D. へ"], "jawaban": 3, "penjelasan": "へ digunakan untuk menunjukkan tujuan arah perpindahan (pergi ke Jepang)." },
    { "soal": "きのう、ともだち ___ えいが ___ みました。", "options": ["A. と・を", "B. や・に", "C. も・が", "D. に・へ"], "jawaban": 0, "penjelasan": "と berarti 'bersama dengan', を menandai 'film' sebagai objek." },
    { "soal": "あさ 7じ ___ おきます。", "options": ["A. で", "B. へ", "C. に", "D. は"], "jawaban": 2, "penjelasan": "に digunakan untuk menandai titik waktu yang spesifik (jam 7)." },
    { "soal": "ここは だれ ___ くるま ですか。", "options": ["A. を", "B. の", "C. が", "D. や"], "jawaban": 1, "penjelasan": "の menghubungkan 'siapa' (だれ) dan 'mobil' (くるま) untuk menanyakan kepemilikan (mobil siapa)." },
    { "soal": "わたし ___ りんご ___ すきです。", "options": ["A. は・が", "B. が・を", "C. は・を", "D. に・が"], "jawaban": 0, "penjelasan": "Dalam pola kalimat kesukaan (すきです), objek yang disukai ditandai dengan が." },
    { "soal": "スーパー ___ パン ___ ぎゅうにゅう ___ かいました。", "options": ["A. に・と・を", "B. で・と・を", "C. で・も・が", "D. へ・や・に"], "jawaban": 1, "penjelasan": "で = tempat aksi (supermarket). と = dan (daftar lengkap). を = objek langsung yang dibeli." },
    { "soal": "A: さくらさんは にほんじん ですか。 B: はい、そうです。キムさん ___ にほんじん です。", "options": ["A. は", "B. が", "C. も", "D. と"], "jawaban": 2, "penjelasan": "も berarti 'juga' (Kim juga orang Jepang)." },
    { "soal": "これは コーヒー です ___ 、こうちゃ です ___ 。", "options": ["A. ね・ね", "B. か・か", "C. よ・よ", "D. は・が"], "jawaban": 1, "penjelasan": "AかBか digunakan untuk menanyakan pilihan 'A atau B'." },
    { "soal": "うち ___ がっこう ___ バスで いきます。", "options": ["A. から・まで", "B. で・に", "C. へ・と", "D. は・が"], "jawaban": 0, "penjelasan": "から = dari, まで = sampai." },
    { "soal": "つくえの うえに ほん ___ ぺん など が あります。", "options": ["A. と", "B. や", "C. も", "D. の"], "jawaban": 1, "penjelasan": "や digunakan untuk mendaftar barang yang tidak lengkap (buku, pulpen, dan lain-lain)." },
    { "soal": "にちようび ___ どこ ___ いきません でした。", "options": ["A. は・も", "B. が・へ", "C. に・を", "D. は・で"], "jawaban": 0, "penjelasan": "どこも + kata kerja negatif berarti 'tidak pergi ke mana-mana'." },
    { "soal": "にほんご ___ じょうず です ___ 。", "options": ["A. が・ね", "B. を・よ", "C. は・か", "D. の・ね"], "jawaban": 0, "penjelasan": "Kata sifat seperti 'pintar/mahir' mengambil partikel が. ね untuk meminta persetujuan 'pintar ya'." },
    { "soal": "この ケーキ ___ おいしい です ___ 。たべて みて ください。", "options": ["A. は・ね", "B. が・か", "C. は・よ", "D. を・よ"], "jawaban": 2, "penjelasan": "は sebagai topik. よ untuk memberikan informasi baru yang pendengar belum tahu 'Kue ini enak lho, cobalah'." },
    { "soal": "えんぴつ ___ かきます。", "options": ["A. を", "B. で", "C. に", "D. が"], "jawaban": 1, "penjelasan": "で digunakan untuk menandai 'alat' atau 'cara' melakukan aksi (menulis DENGAN pensil)." },
    { "soal": "あした は あめ ___ ふります。", "options": ["A. を", "B. で", "C. に", "D. が"], "jawaban": 3, "penjelasan": "Fenomena alam seperti hujan turun menggunakan が (あめ が ふります)." },
    { "soal": "わたしは まいあさ 6じ ___ から 7じ ___ うんどう します。", "options": ["A. から・まで", "B. に・に", "C. で・で", "D. は・が"], "jawaban": 0, "penjelasan": "から = dari jam 6, まで = sampai jam 7." }
]
;
...
function startQuiz() {
    ...
    // Ambil 5 soal secara acak dari bank soal
    quizData = shuffleArray([...quizBank]).slice(0, 5);
...
// Data Ujian JLPT
const ujianBank = [
    { "type": "mcq", "soal": "えき ___ でんしゃ ___ のります。", "options": ["A. に・を", "B. で・に", "C. は・へ", "D. で・が"], "jawaban": 1, "penjelasan": "で = tempat (di stasiun). に = target aksi untuk naik kendaraan (naik ke kereta)." },
    { "type": "essay", "soal": "きのう、どこ ___ 行きませんでした。(Tidak pergi ke mana-mana)", "jawaban": "も", "penjelasan": "どこも + kalimat negatif = tidak ke mana-mana." },
    { "type": "mcq", "soal": "わたし ___ りんご ___ すきです。", "options": ["A. は・が", "B. が・を", "C. は・を", "D. に・が"], "jawaban": 0, "penjelasan": "Dalam pola kesukaan (suki), objek yang disukai ditandai dengan が." },
    { "type": "essay", "soal": "くるま ___ きました。(Datang dengan mobil)", "jawaban": "で", "penjelasan": "で menandai alat atau sarana yang digunakan." },
    { "type": "mcq", "soal": "A: きょうは いい てんき です ___ 。 B: そうですね。", "options": ["A. か", "B. よ", "C. ね", "D. が"], "jawaban": 2, "penjelasan": "ね digunakan untuk mengharapkan persetujuan lawan bicara." },
    { "type": "essay", "soal": "ともだち ___ あいます。(Bertemu teman)", "jawaban": "に", "penjelasan": "あいます (bertemu) selalu membutuhkan target pertemuan dengan partikel に." },
    { "type": "mcq", "soal": "ここは だれ ___ くるま ですか。", "options": ["A. を", "B. の", "C. が", "D. や"], "jawaban": 1, "penjelasan": "の digunakan untuk menghubungkan dua kata benda menjadi satu kesatuan (mobil milik siapa)." },
    { "type": "essay", "soal": "月曜日 ___ 金曜日 ___ はたらきます。(Bekerja dari senin sampai jumat)", "jawaban": ["から", "まで"], "penjelasan": "A から B まで = Dari A sampai B." }
]
;
...
function startUjian() {
    ...
    ujianData = shuffleArray([...ujianBank]).slice(0, 8);
